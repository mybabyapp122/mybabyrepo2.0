                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div class="dlab-scroll px-3 mt-3 height300">
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{ asset('theme-related/images/avatar/1.jpg') }}" class="avatar avatar-sm" alt="">
                            ...
                            <div class="dropdown-menu dropdown-menu-end pb-0" style="">
                                <div class="card mb-0">
                                    ...
                                    <div class="card-footer text-center p-3">
                                        <a href="{{ route('logout') }}" class="dropdown-item ai-icon btn btn-primary light" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item ai-icon btn btn-primary light">
