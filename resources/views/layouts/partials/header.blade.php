                    ...
                    <li class="nav-item dropdown notification_dropdown all">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <svg height="24" class="svg-main-icon" viewBox="0 0 32 32" width="24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <clipPath id="clip_1"><path id="artboard_1" clip-rule="evenodd" d="m0 0h32v32h-32z"/></clipPath>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('theme-related/images/avatar/1.jpg') }}">
                                            </div>
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('theme-related/images/user.jpg') }}" alt="">
                                </div>
                            </a>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="{{ asset('theme-related/images/user.jpg') }}" class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
                                                <h4 class="mb-0">{{ Auth::user()->name ?? 'Admin' }}</h4>
                                                <span>Admin</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-footer text-center p-3">
                                        <a href="{{ route('logout') }}" class="dropdown-item ai-icon btn btn-primary light" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
