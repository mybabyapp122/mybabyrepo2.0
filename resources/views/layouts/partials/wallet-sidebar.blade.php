            ...
            <div class="card bg-transparent mb-1">
                ...
                <div class="card-body height450 dlab-scroll loadmore-content recent-activity-wrapper p-3 pt-2" id="RecentActivityContent">
                    ...
                    <div class="d-flex align-items-center student">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/profile/small/pic1.jpg') }}" alt="" width="50" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="d-flex align-items-center student">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/profile/small/pic2.jpg') }}" alt="" width="50" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="d-flex align-items-center student">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/profile/small/pic3.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="d-flex align-items-center student">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/profile/small/pic4.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="d-flex align-items-center student">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/profile/small/pic5.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
                ...
                <div class="card-body height450 dlab-scroll p-0 px-3" id="messageContent">
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
                            <span class="dz-media">
                                <img src="{{ asset('theme-related/images/profile/small/pic1.jpg') }}" alt="" class="avatar">
                            </span>
                            <div class="user-info">
                                <h6 class="name"><a href="app-profile.html">Samantha William</a></h6>
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
                            <span class="dz-media">
                                <img src="{{ asset('theme-related/images/profile/small/pic2.jpg') }}" alt="" class="avatar">
                            </span>
                            <div class="user-info">
                                <h6 class="name"><a href="app-profile.html">Tony Soap</a></h6>
                                <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
            ...
            <div class="card tags bg-transparent mb-0">
                ...
                <div class="card-body  p-3 py-1 ">
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/food/pic1.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/food/pic2.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('theme-related/images/food/pic3.jpg') }}" alt="" class="avatar">
                        </span>
                        <div class="user-info">
